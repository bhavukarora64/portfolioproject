...
export default function Principles(){
    return(
        <>
            <div id='principles-section' className='col-span-12 text-7xl font-bold flex justify-center my-24'>Principles</div>
            <div className="grid grid-cols-12 gap-4 mt-24 mx-24 group">
                <div className=' bg-blue-200 col-span-5 h-96 w-full rounded-xl flex flex-col justify-between px-6 py-6 group-hover:scale-98 hover:!scale-102 transition-all duration-200 ease-in-out'>
                ...
                <div className=' bg-green-200 col-span-4 h-96 w-full rounded-xl flex flex-col justify-between px-6 py-6 group-hover:scale-98 hover:!scale-102 transition-all duration-200 ease-in-out'>
                ...
                <div className=' bg-orange-200 col-span-3 row-span-2 h-full w-full rounded-xl flex flex-col justify-between px-6 py-6 group-hover:scale-98 hover:!scale-102 transition-all duration-200 ease-in-out'>
                ...
                <div className=' bg-yellow-200 col-span-4 h-96 w-full rounded-xl flex flex-col justify-between px-6 py-6 group-hover:scale-98 hover:!scale-102 transition-all duration-200 ease-in-out'>
                ...
                <div className=' bg-purple-200 col-span-5 h-96 w-full rounded-xl flex flex-col justify-between px-6 py-6 group-hover:scale-98 hover:!scale-102 transition-all duration-200 ease-in-out'>
